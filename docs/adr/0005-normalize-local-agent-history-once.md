# Normalize local coding-agent history once

WorkHistory privately adapts Claude Code, Codex, Gemini CLI, and GitHub Copilot
records into provider-neutral local events, then serves timeline, links, search,
