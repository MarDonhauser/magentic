export namespace core {
	...
	export class Item {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.vendorLabel = source["vendorLabel"];
	        this.delegated = source["delegated"];
	...
	export class OvUsageWindow {
	    ...
	    static createFrom(source: any = {}) {
	        return new OvUsageWindow(source);
	    }
	...
	export class OvUsagePage {
	    provider: string;
	    label: string;
	    windows: OvUsageWindow[];
	
	    static createFrom(source: any = {}) {
	        return new OvUsagePage(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.provider = source["provider"];
	        this.label = source["label"];
	        this.windows = this.convertValues(source["windows"], OvUsageWindow);
	    }
	...
	export class SidebarNode {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.children = this.convertValues(source["children"], SidebarNode);
	    }
	...
	export class Overview {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.usage = this.convertValues(source["usage"], OvUsagePage);
	        this.projects = this.convertValues(source["projects"], OvProject);
	        this.later = this.convertValues(source["later"], OvLater);
	        this.sidebar = this.convertValues(source["sidebar"], SidebarNode);
	    }
