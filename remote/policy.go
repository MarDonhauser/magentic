...
var RemoteActionPolicy = map[string]PolicyEntry{
	...
	"AnswerManagedPermission": {ActionPermitted, "Berechtigungsantwort an die Session"},
	"InterruptManagedTurn":    {ActionPermitted, "Unterbrechung des laufenden Turns"},
	...
	"ManagedSessionState":     {ActionRestricted, "Nur lokale Bedienung: Steuerstand der verwalteten Runtime dieses Rechners"},
